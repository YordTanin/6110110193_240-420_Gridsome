  ...
  <div>
    <div class="container flex flex-wrap">
      <div class="w-full md:w-1/2">
        ...
        >
          <a :href="element.link" v-if="element.external" target="_white" rel="noopener noreferrer">{{ element.name }}</a>
      ...
      <div class="w-full md:w-1/2 hidden md:block self-center">
        ...
        >
          <span class="text-sm">
          <a :href="element.link" target="_white" rel="noopener noreferrer">
